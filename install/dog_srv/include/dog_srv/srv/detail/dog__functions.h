...
#ifndef DOG_SRV__SRV__DETAIL__DOG__FUNCTIONS_H_
#define DOG_SRV__SRV__DETAIL__DOG__FUNCTIONS_H_
...
#include "dog_srv/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_dog_srv
bool
 ...
 * calls
 * dog_srv__srv__Dog_Request__init().
...
/**
 * It calls
 * dog_srv__srv__Dog_Request__fini()
 ...
 * dog_srv__srv__Dog_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dog_srv__srv__Dog_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dog_srv__srv__Dog_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dog_srv
...
/**
 * It calls
 * dog_srv__srv__Dog_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dog_srv
...
/**
 * It allocates the memory for the array and calls
 * dog_srv__srv__Dog_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dog_srv
...
/**
 * It calls
 * dog_srv__srv__Dog_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DOG_SRV__SRV__DETAIL__DOG__FUNCTIONS_H_
