...
{
  tutorial_interfaces__srv__AddThreeInts_Request * msg = (tutorial_interfaces__srv__AddThreeInts_Request *)malloc(sizeof(tutorial_interfaces__srv__AddThreeInts_Request));
  if (!msg) {
    return NULL;
  }
...
tutorial_interfaces__srv__AddThreeInts_Request__Sequence__init(tutorial_interfaces__srv__AddThreeInts_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tutorial_interfaces__srv__AddThreeInts_Request *)calloc(size, sizeof(tutorial_interfaces__srv__AddThreeInts_Request));
    if (!data) {
      return false;
    }
...
{
  tutorial_interfaces__srv__AddThreeInts_Request__Sequence * array = (tutorial_interfaces__srv__AddThreeInts_Request__Sequence *)malloc(sizeof(tutorial_interfaces__srv__AddThreeInts_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  tutorial_interfaces__srv__AddThreeInts_Response * msg = (tutorial_interfaces__srv__AddThreeInts_Response *)malloc(sizeof(tutorial_interfaces__srv__AddThreeInts_Response));
  if (!msg) {
    return NULL;
  }
...
tutorial_interfaces__srv__AddThreeInts_Response__Sequence__init(tutorial_interfaces__srv__AddThreeInts_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tutorial_interfaces__srv__AddThreeInts_Response *)calloc(size, sizeof(tutorial_interfaces__srv__AddThreeInts_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  tutorial_interfaces__srv__AddThreeInts_Response__Sequence * array = (tutorial_interfaces__srv__AddThreeInts_Response__Sequence *)malloc(sizeof(tutorial_interfaces__srv__AddThreeInts_Response__Sequence));
  if (!array) {
    return NULL;
  }
