...
#include <stddef.h>
#include "dog_interfaces/srv/detail/dog__rosidl_typesupport_introspection_c.h"
#include "dog_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  dog_interfaces__srv__Dog_Request__init(message_memory);
}

void Dog_Request__rosidl_typesupport_introspection_c__Dog_Request_fini_function(void * message_memory)
{
  dog_interfaces__srv__Dog_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Dog_Request__rosidl_typesupport_introspection_c__Dog_Request_message_member_array[1] = {
  {
    ...
    offsetof(dog_interfaces__srv__Dog_Request, breed),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Dog_Request__rosidl_typesupport_introspection_c__Dog_Request_message_members = {
  "dog_interfaces__srv",  // message namespace
  "Dog_Request",  // message name
  1,  // number of fields
  sizeof(dog_interfaces__srv__Dog_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_dog_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_interfaces, srv, Dog_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  dog_interfaces__srv__Dog_Response__init(message_memory);
}

void Dog_Response__rosidl_typesupport_introspection_c__Dog_Response_fini_function(void * message_memory)
{
  dog_interfaces__srv__Dog_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Dog_Response__rosidl_typesupport_introspection_c__Dog_Response_message_member_array[4] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dog_interfaces__srv__Dog_Response, name),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dog_interfaces__srv__Dog_Response, age),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dog_interfaces__srv__Dog_Response, sex),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dog_interfaces__srv__Dog_Response, breed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Dog_Response__rosidl_typesupport_introspection_c__Dog_Response_message_members = {
  ...
  4,  // number of fields
  sizeof(dog_interfaces__srv__Dog_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_dog_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_interfaces, srv, Dog_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_service_members = {
  "dog_interfaces__srv",  // service namespace
  "Dog",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_Request_message_type_support_handle,
  NULL  // response message
  // dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_Response_message_type_support_handle
};

static rosidl_service_type_support_t dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_service_type_support_handle = {
  0,
  &dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_interfaces, srv, Dog)() {
  if (!dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_service_type_support_handle.typesupport_identifier) {
    dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_interfaces, srv, Dog_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_interfaces, srv, Dog_Response)()->data;
  }

  return &dog_interfaces__srv__detail__dog__rosidl_typesupport_introspection_c__Dog_service_type_support_handle;
}
