...
class Metaclass_Dog_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('dog_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Dog(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dog_interfaces.srv import _dog
...
class Dog(metaclass=Metaclass_Dog):
    from dog_interfaces.srv._dog import Dog_Request as Request
    from dog_interfaces.srv._dog import Dog_Response as Response
