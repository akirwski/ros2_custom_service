...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddThreeInts_Request_message_member_array[1] = {
  {
    "breed",  // name
    ...
    offsetof(tutorial_interfaces::srv::AddThreeInts_Request, breed),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddThreeInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::srv::AddThreeInts_Response, breed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
