...
static rosidl_typesupport_introspection_c__MessageMember AddThreeInts_Request__rosidl_typesupport_introspection_c__AddThreeInts_Request_message_member_array[1] = {
  {
    "breed",  // name
    ...
    offsetof(tutorial_interfaces__srv__AddThreeInts_Request, breed),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember AddThreeInts_Response__rosidl_typesupport_introspection_c__AddThreeInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces__srv__AddThreeInts_Response, breed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
