...
static const _Dog_Request_type_support_symbol_names_t _Dog_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dog_interfaces, srv, Dog_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dog_interfaces, srv, Dog_Request)),
  }
};
...
{
  return &::dog_interfaces::srv::rosidl_typesupport_cpp::Dog_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dog_interfaces, srv, Dog_Request)() {
  return get_message_type_support_handle<dog_interfaces::srv::Dog_Request>();
}
...
static const _Dog_Response_type_support_symbol_names_t _Dog_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dog_interfaces, srv, Dog_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dog_interfaces, srv, Dog_Response)),
  }
};
...
{
  return &::dog_interfaces::srv::rosidl_typesupport_cpp::Dog_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dog_interfaces, srv, Dog_Response)() {
  return get_message_type_support_handle<dog_interfaces::srv::Dog_Response>();
}
...
static const _Dog_type_support_symbol_names_t _Dog_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dog_interfaces, srv, Dog)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dog_interfaces, srv, Dog)),
  }
};
...
{
  return &::dog_interfaces::srv::rosidl_typesupport_cpp::Dog_service_type_support_handle;
}
