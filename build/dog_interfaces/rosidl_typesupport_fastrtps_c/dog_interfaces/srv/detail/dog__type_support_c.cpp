...
#include "dog_interfaces/srv/detail/dog__rosidl_typesupport_fastrtps_c.h"
...
#include "dog_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Dog_Request__ros_msg_type = dog_interfaces__srv__Dog_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dog_interfaces
size_t get_serialized_size_dog_interfaces__srv__Dog_Request(
  const void * untyped_ros_message,
...
static uint32_t _Dog_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dog_interfaces__srv__Dog_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dog_interfaces
size_t max_serialized_size_dog_interfaces__srv__Dog_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dog_interfaces__srv__Dog_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dog_interfaces, srv, Dog_Request)() {
...
using _Dog_Response__ros_msg_type = dog_interfaces__srv__Dog_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dog_interfaces
size_t get_serialized_size_dog_interfaces__srv__Dog_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Dog_Response__ros_msg_type * ros_message = static_cast<const _Dog_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dog_interfaces__srv__Dog_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dog_interfaces
size_t max_serialized_size_dog_interfaces__srv__Dog_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_dog_interfaces__srv__Dog_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dog_interfaces, srv, Dog_Response)() {
...
// already included above
// #include "dog_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dog_interfaces/srv/dog.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dog_interfaces, srv, Dog)() {
  return &Dog__handle;
}
