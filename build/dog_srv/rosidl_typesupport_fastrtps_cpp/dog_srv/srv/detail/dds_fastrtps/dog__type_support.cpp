...
#include "dog_srv/srv/detail/dog__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const dog_srv::srv::Dog_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dog_srv::srv::Dog_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dog_srv
const rosidl_message_type_support_t *
get_message_type_support_handle<dog_srv::srv::Dog_Request>()
{
  return &dog_srv::srv::typesupport_fastrtps_cpp::_Dog_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const dog_srv::srv::Dog_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dog_srv::srv::Dog_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dog_srv::srv::typesupport_fastrtps_cpp::_Dog_Response__handle;
}
...
{
  return &dog_srv::srv::typesupport_fastrtps_cpp::_Dog__handle;
}
