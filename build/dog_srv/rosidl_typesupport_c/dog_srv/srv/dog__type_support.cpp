...
#include "dog_srv/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Dog_Request_type_support_symbol_names_t _Dog_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dog_srv, srv, Dog_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_srv, srv, Dog_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dog_srv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dog_srv, srv, Dog_Request)() {
  return &::dog_srv::srv::rosidl_typesupport_c::Dog_Request_message_type_support_handle;
}
...
static const _Dog_Response_type_support_symbol_names_t _Dog_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dog_srv, srv, Dog_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_srv, srv, Dog_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_dog_srv
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dog_srv, srv, Dog_Response)() {
  return &::dog_srv::srv::rosidl_typesupport_c::Dog_Response_message_type_support_handle;
}
...
static const _Dog_type_support_symbol_names_t _Dog_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dog_srv, srv, Dog)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dog_srv, srv, Dog)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dog_srv, srv, Dog)() {
  return &::dog_srv::srv::rosidl_typesupport_c::Dog_service_type_support_handle;
}
